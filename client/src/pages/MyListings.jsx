import { ArrowDownCircleIcon, BanIcon, CheckCheck, CheckCheckIcon, CheckCircle, Clock, CoinsIcon, DollarSign, Edit, Eye, EyeIcon, EyeOff, EyeOffIcon, LockIcon, Plus, StarIcon, TrashIcon, TrendingUp, Users, WalletIcon, XCircle } from 'lucide-react';
...
const MyListings = () => {
  ...
  return (
    <div  className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
       {/* header */}
        <div className='flex flex-col md:flex-row justify-between itmes-start md:items-center mb-8'>
              <div className=''>
         ...
         <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
            ...
            <StatCard title="Active Listings" value={activeListings.length} icon={<CheckCircle className='size-6 text-green-600 ' />} color="green"  />
                      ...
                      <div className='p-6'>
                                    ...
                                    <div className='flex justify-between itmes-start'>
                                        ...
                                        <div className='flex items-center gap-3'>
                                          <div className='relative group'>
                                            <LockIcon size={14}/>
                                            <div className='invisible group-hover:visible absolute right-0 pt-4.5 z-10'>
                                                <div className='bg-white text-gray-600 text-xs rounded border-gray-200 p-2 px-3'>
                                                  ...
                                                  <button className='text-nowrap'>
                                                    Status:{" "}
                                                    <span className={listing.isCredentialSubmitted?
                                          ...
                                          {listing.status==="active"&&(
                                            <StarIcon onClick={()=>markAsFeatured(listing.id)}
                          ...
                          <div className='space-y-4'>
                             ...
                             <div className='flex items-center justify-between pt-3 border-t border-gray-200'>
                                       <span>{currency}{listing.price.toLocaleString()}</span> 
                                       <div className='flex items-center space-x-2'>
                                        {listing.status!=="sold"&&(
                                        ...
                                        <button onClick={()=>toggleStatus(listing.id)} className='p-2 border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-purple-600'>{listing.status==="active" &&(<EyeOffIcon className='size-4'/>)}{listing.status!=="active"&& (<EyeIcon className='size-4'/>)}</button>
                                        </div>    
                             </div>
                      </div>
                  </div>
