...
import { ArrowLeft, ArrowUpRightFromSquare, Calendar, CheckCircle2, ChevronLeft, ChevronRight, DollarSign, Eye, LineChart, Loader2, MapPin, MessageSquareMore, ShoppingBag, Users } from 'lucide-react';
    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex items-start max-md:flex-col gap-10'>
        <div className='flex-1 max-md:w-full'>
          ...
          {images?.length > 0 && (
            <div className='bg-white rounded-xl border border-gray-200 mb-5 overflow-hidden'>
              <div className='p-4'>
                <h4 className='font-semibold text-gray-800'>Screenshots and proofs</h4>
              </div>
              {/* Slider container */}
          ...
          <div className='bg-white rounded-xl border border-gray-200 mb-5 '>
            <div className='p-4 border-b border-gray-100'>
              <h4 className='font-semibold text-gray-800'>Additinal Details</h4>
            </div>
        ...
        <div className='bg-white min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:md-10'>
          ...
          <div className='flex itmes-center gap-3 mb-2'>
