    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
        <div className='py-10'>
            ...
            <div className='mb-8'>
                ...
                <p className='text-gray-600'>Chat with buyers ans sellers</p>
            </div>
            ...
            {loading?(
              ...
              <div className='bg-white rounded-lg shadow-xs border border-gray-200 p-16 text-center'>
                  ...
                  <h3 className='text-xl font-medium text-gray-800 mb-2'>{searchQuery?"No chat found":"No message yet"}</h3>
                         ...
                         key={chat.id} className='w-full p-4 hover:bg-gray-50 transition-colors text-left'>
                          <div className='flex items-start space-x-4'>
                            <div className='flex-shrink-0'>
                              <img src={chatUser?.image} alt="" className='w-12 h-12 rounded-lg object-cover'/>
                            </div>
